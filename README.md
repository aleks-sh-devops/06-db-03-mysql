...
+----------+------------+----------------------------------------------+
|        1 | 0.00133950 | select count(*) from orders where price >300 |
|        2 | 0.03710725 | alter table orders engine = MyISAM           |
|        3 | 0.00128575 | select count(*) from orders where price >300 |
+----------+------------+----------------------------------------------+
